...
- Current design is in [Design Memory](../design/README.md). Deferred items remain in [project backlog](../backlogs/project.md), [recover-run backlog](../backlogs/recover-run.md), and [run-local backlog](../backlogs/run-local.md). The session note is [Ready inspect and resume](../reports/note/2026-08-18-ready-inspect-resume.md).
