...
- Current empty-graph rule: An empty graph is `invalid-value` at Validate, BuildPlan, Run, and Resume. Inspect or Release of a workspace with zero latest attempts is not success.
- Source: `interfaces`
