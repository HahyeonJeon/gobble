...
// Tree. A ready Tree takes precedence and omits genome preparation. A generated
// Tree contains the staged FASTA and every Bismark-created member.
...
// Contract is the compile-time Methyl pipeline surface.
