// Package featurecounts owns the graph-stable featureCounts command module.
...
// AddInput.
func AddFeatureCounts(parent modules.Parent, bam, gtf gobble.Handle, opts FeatureCountsOptions) FeatureCountsPorts {
...
func FeatureCountsPipeline(bam, gtf gobble.PathSpec, opts FeatureCountsOptions) *gobble.Pipeline {
	return modules.Standalone("featurecounts", []modules.Input{
		{Name: "bam", Spec: bam},
		{Name: "gtf", Spec: gtf},
...
func addFeatureCounts(parent modules.Parent, bam, gtf gobble.Handle, opts FeatureCountsOptions) FeatureCountsPorts {
	...
	cmd := []string{
		"featureCounts",
		"-a", modules.MustCommandPath(gtf.Spec()),
		"-o", modules.MustCommandPath(countsSpec),
		"-p",
