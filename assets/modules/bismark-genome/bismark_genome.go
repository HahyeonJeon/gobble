// Package bismarkgenome owns the graph-stable Bismark genome command module.
...
func bismarkRestagedFASTA() gobble.PathSpec {
...
func AddBismarkGenome(parent modules.Parent, fasta gobble.Handle, opts BismarkGenomeOptions) BismarkGenomePorts {
...
func BismarkGenomePipeline(fasta gobble.PathSpec, opts BismarkGenomeOptions) *gobble.Pipeline {
	return modules.Standalone("bismark-genome", []modules.Input{{Name: "fasta", Spec: fasta}}, func(parent modules.Parent, hs []gobble.Handle) {
...
func addBismarkGenome(parent modules.Parent, fasta gobble.Handle, opts BismarkGenomeOptions) BismarkGenomePorts {
	...
	task := parent.AddTask(gobble.TaskSpec{
		...
		Command:   cmd,
		Image:     bismarkImage,
		Inputs:    []gobble.Bind{{Name: "fasta", From: fasta, Spec: bismarkRestagedFASTA()}},
