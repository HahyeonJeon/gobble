package mergecounts_test

import (
	"testing"

	"github.com/HahyeonJeon/gobble"
	. "github.com/HahyeonJeon/gobble/assets/modules/merge-counts"
...
func TestMergeCountsStandaloneComposeBuildPlan(t *testing.T) {
	...
	task := pc.TaskByID(t, raw, "merge_counts")
	...
	pc.AssertIOPath(t, task.Inputs, "counts_0", "work/ctrl1/featurecounts/counts.txt")
	pc.AssertIOPath(t, task.Inputs, "counts_1", "work/treat1/featurecounts/counts.txt")
	pc.AssertIOPath(t, task.Outputs, "counts", "work/deseq2/counts.csv")
}
